...
export const ACCOUNT_TIERS = {
  '25K': {
    ...
    rules: [
      'Max 3 PDT trades per rolling 5 days',
      'Only trade A+ setups — no B/C trades',
      'Stop at 2 losers in a day',
      'No revenge trading',
      'Must take screenshots for entry/exit',
      'Require detailed notes for each trade',
      'Focus on 1-2 high-quality setups only',
      'Risk max 1% per trade ($250)',
      'Maintain 1.5:1 minimum risk/reward ratio'
    ],
  },
  ...
  '50K': {
    ...
    rules: [
      'Max 2% account loss per day ($1,000)',
  ...
  '100K': {
    ...
    rules: [
      'Max 2% daily loss ($2,000)',
      'Risk 1% per trade ($1,000)',
      'Max 4 concurrent positions',
      'Scale out at 3R, trail the rest',
    ],
  },
  ...
  '200K': {
    ...
    rules: [
      'Max 2% daily loss ($4,000)',
      'Conservative 0.75% per trade ($1,500)',
      'Max 5 concurrent positions',
      'Larger size on A+ float setups only',
    ],
  },
