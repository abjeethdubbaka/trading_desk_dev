...
export default function TradeReviewPanel({ trade, review, isLoading, onRequest, isOpen, onToggle, onClear }) {
  return (
    <div className="border-t border-white/5 mt-2 pt-2">
      <button
        onClick={()=>{ onToggle(); if(!review&&!isLoading) onRequest(trade); }}
        className="flex items-center gap-1.5 text-xs text-purple-400/70 hover:text-purple-300 transition-colors py-0.5"
      >
