...
import { getFloatCategoryWithInfo } from '../utils/floatHelpers.js';
...
export class PositionCalculator {
  ...
  getDynamicAdjustments(floatSize, floatCategories) {
    ...
    const category = getFloatCategoryWithInfo(floatSize, floatCategories);
    if (!category) return [];
  ...
  calculateTargets(calculation, targetProfitDollars, floatSize = null, settings = {}, floatCategories = {}) {
    ...
    const floatCategory = floatSize ? getFloatCategoryWithInfo(floatSize, floatCategories) : null;
