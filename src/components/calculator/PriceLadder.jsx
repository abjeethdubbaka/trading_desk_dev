  ...
  return (
    <div className="bg-[#13131e] border border-white/8 rounded-xl p-4 space-y-4">
      ...
      <div className="relative h-7 bg-white/4 rounded-lg mx-1">
        <div className="absolute top-0 bottom-0 rounded-l-lg bg-red-500/10" style={{ left: `${pct(stop)}%`, width: `${pct(entry) - pct(stop)}%` }} />
        <div className="absolute top-0 bottom-0 bg-emerald-500/10" style={{ left: `${pct(entry)}%`, width: `${pct(levels[levels.length - 1].price) - pct(entry)}%` }} />
